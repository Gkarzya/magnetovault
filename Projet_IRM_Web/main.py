...
with t7:
    ...
    t_90 = 10
    # LABELS ET LEGENDES MIS A JOUR ICI
    if is_gre:
        ...
        fig, axs = plt.subplots(5, 1, sharex=True, figsize=(10, 8), gridspec_kw={'hspace': 0.3}) # hspace augmenté pour lisibilité
        ...
        axs[0].set_ylabel("RF (Radiofréq.)"); axs[0].set_yticks([0, 1], ["", f"{flip_angle}°"]); axs[0].spines['top'].set_visible(False)
        ...
        axs[1].plot(t, gsc, color='green'); axs[1].fill_between(t, 0, gsc, color='green', alpha=0.6); axs[1].set_ylabel("Gss (Sélection)")
        gcp = np.zeros_like(t); t_code = t_90 + 15; mask_c = (t > t_code - grad_width) & (t < t_code + grad_width); gcp[mask_c] = 0.5
        axs[2].plot(t, gcp, color='orange'); axs[2].fill_between(t, 0, gcp, color='orange', alpha=0.6); axs[2].set_ylabel("Gpe (Phase)")
        ...
        axs[3].plot(t, gcf, color='dodgerblue'); axs[3].fill_between(t, 0, gcf, color='dodgerblue', alpha=0.6); axs[3].set_ylabel("Gro (Lecture)")
        ...
        axs[4].plot(t, sig, color='navy'); axs[4].set_ylabel("Signal (Echo)"); axs[4].axvline(x=t_read, color='red', linestyle='--'); axs[4].text(t_read, 1.1, f"TE={te:.0f}ms", color='red', ha='center')
        ...
        axs[0].set_ylabel("RF (Radiofréq.)"); axs[0].set_yticks([0, 1, 1.6], ["", "90", "180"]); axs[0].spines['top'].set_visible(False); axs[0].spines['right'].set_visible(False); axs[0].set_xlim(0, t_max)
        gsc = np.zeros_like(t)
        ...
        axs[1].fill_between(t, 0, gsc, color='green', alpha=0.6); axs[1].plot(t, gsc, color='green', linewidth=1); axs[1].set_ylabel("Gss (Sélection)"); axs[1].set_yticks([]); axs[1].spines['top'].set_visible(False); axs[1].spines['right'].set_visible(False)
        ...
        axs[2].fill_between(t, 0, gcp, color='darkorange', alpha=0.7); axs[2].set_ylabel("Gpe (Phase)"); axs[2].set_yticks([]); axs[2].spines['top'].set_visible(False); axs[2].spines['right'].set_visible(False)
        ...
        axs[3].fill_between(t, 0, gcf, color='dodgerblue', alpha=0.5); axs[3].set_ylabel("Gro (Lecture)"); axs[3].set_yticks([]); axs[3].spines['top'].set_visible(False); axs[3].spines['right'].set_visible(False)
        sig = np.zeros_like(t)
        for i, t_e in enumerate(echo_times):
            if t_e < t_max - 5:
        ...
        axs[4].plot(t, sig, color='navy', linewidth=1.5); axs[4].set_ylabel("Signal (Echo)"); axs[4].set_xlabel("Temps (ms)"); axs[4].set_yticks([]); axs[4].spines['top'].set_visible(False); axs[4].spines['right'].set_visible(False)
        st.pyplot(fig); plt.close(fig)
